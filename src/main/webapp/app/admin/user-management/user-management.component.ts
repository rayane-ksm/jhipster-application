      ...
      this.userManagementService
        ...
        .then(res => {
          this.alertService.showInfo(
            this.t$(res.headers['x-jhipsterapplicationfootballapp-alert'].toString(), {
              param: decodeURIComponent(res.headers['x-jhipsterapplicationfootballapp-params'].replace(/\+/g, ' ')),
            }),
            { variant: 'danger' },
          );
          this.removeId = null;
